      ...
      {isVisible && (
        <div className=''>
          <div className='flex flex-col items-center justify-center px-10'>
            <p>
              2025년 3월, 어린 독수리 팜쭈는 백양로 아스팔트에 불시착한 후, 팜희를 사부로 삼아 대학
              생활을 배우기 시작한다. 끝없는 호기심과 탐구욕으로 연세대 곳곳을 누비는 팜쭈! <br />{' '}
              <br />
              팜희는 팜쭈의 열정에 감동받고, 싱크로나이즈드 비행학과 과대 로서 이 친구를 완벽한
              연대생으로 만들어주기 위해 후배의 대학 생활을 앞장서서 돕기 시작한다. 합응, 아카라카,
              연고전 등등을 거치며 여러 퀘스트들을 하나하나 깨나가는데...{' '}
            </p>
          </div>
          <div className='flex ml-7 mt-15'>
            ...
            <div className='w-full mt-1 mx-3 bg-white p-3 rounded-2xl'>
              <div className='text-sm'>
                안녕! 나는 팜쭈의 짝선 독팜희야. 다시 만나서 반가워. 설마 벌써 나를 까먹진 않았지?!
                나는 연세대학교 싱크로나이즈드 비행학과 24학번이고, 올해 쪼끔 더 커서 키도 40cm나
                되는 선배 독수리라구! 그럼 모두 우리 후배 팜쭈 잘 부탁해💙🩵
              </div>
            </div>
          </div>
        </div>
